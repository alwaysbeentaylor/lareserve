            ...
            <div className="modal max-w-lg" onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="p-6 space-y-4">
                        ...
                        {/* Start Research Option */}
                        <div className="flex items-center gap-3 p-4 bg-[var(--color-bg-secondary)] rounded-lg">
                            <input
                                type="checkbox"
                                id="start-research"
                                checked={startResearch}
                                onChange={(e) => setStartResearch(e.target.checked)}
                                className="w-4 h-4 accent-[var(--color-accent-gold)]"
                            />
                            <label htmlFor="start-research" className="text-sm">
                                Direct onderzoek starten na toevoegen
                            </label>
                        </div>
